...
function event_check($checkarray,$time){
	

$conditions = array();
$conditions[0] = array("tv","lights");
$conditions[1] = array ("heater","door");
$conditions[2] = array("washing","drying","dishwashing");
//var_dump($checkarray["power-net"]);
//if($checkarray["power-generated"] < $power_generated );
if($checkarray["power-net"] > 1500 && $checkarray["power-net"] < 2000){
$id = get_input_id(1,"power-net");
event_add_new(1,$id,1,$checkarray["power-net"],0,0,0,$time);}

if($checkarray["power-net"] > 2000 && $checkarray["power-net"] < 2800){
$id = get_input_id(1,"power-net");
event_add_new(1,$id,1,$checkarray["power-net"],0,0,0,$time);
event_add_new(1,$id,2,$checkarray["power-net"],0,0,0,$time);}

if($checkarray["power-net"] > 2800){
$id = get_input_id(1,"power-net");
event_add_new(1,$id,1,$checkarray["power-net"],0,0,0,$time);
event_add_new(1,$id,2,$checkarray["power-net"],0,0,0,$time);}
