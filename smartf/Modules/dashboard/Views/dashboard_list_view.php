...
<!-- tool menu TODO:is the same at dashboard_thumb_\" so it could be include from one place to share code -->
<div style="float:right">
  ...
  <a href="<?php echo $path; ?>dashboard/thumb" title="<?php echo _("Thumb"); ?>"><i class="icon-th-large"></i></a>
          ...
          if ($dashboard['published']) {
            if ($dashboard['public']) {  ?>
              <a href="<?php echo $GLOBALS['path'].$user['username']."&amp;id=".$dashboard['id'] ?>" title="<?php echo _('Public share URL'); ?>"><i class='icon-share'></i></a>
						<?php } else { ?>
    	        <a href="<?php echo $GLOBALS['path'].$user['username']."&amp;id=".$dashboard['id']."&amp;apikey=".$user['apikey_read'] ?>" title="Private share"><i class='icon-share'></i></a>
      	    <?php         
        			} 
          } ?>
      </td>   
