...
<div id="page-container" style="height:<?php echo $dashboard['height']; ?>px; position:relative; width:1250px;">
  <div id="page"><?php echo $dashboard['content']; ?></div>
  <canvas id="can" width="1250px" height="<?php echo $dashboard['height']; ?>px" style="position:absolute; top:0px; left:0px; margin:0; padding:0;"></canvas>

  <div id="testo" style="position:absolute; top:0px; left:0px; width:1250px; background-color:rgba(255,255,255,0.9); border: 1px solid #ddd;">
