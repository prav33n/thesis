...
function event_add_new($userid,$eventfeed,$eventtype,$eventvalue,$action,$setfeed,$setvalue,$time)
{
  db_query("INSERT INTO event (`userid`,`eventfeed`, `eventtype`, `eventvalue`, `action`, `setfeed`, `setvalue`,`lasttime`) VALUES ('$userid','$eventfeed','$eventtype','$eventvalue','$action','$setfeed','$setvalue','$time')");
}