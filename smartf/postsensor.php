...
for ($i = 0;$i<1000; $i++) {
   $data= "http://localhost/smartf/input/post?json=".generategeneralconsumption()."&apikey=95876437f3b43ac241fdcd29658770ff";
   depthpost($data, "");
   if(($i%25)==0){
   	$data= "http://localhost/smartf/input/post?json=".generatemidconsumption()."&apikey=95876437f3b43ac241fdcd29658770ff";
   depthpost($data, "");
   }
 if(($i%50)==0){
   $data= "http://localhost/smartf/input/post?json=".generatemaxconsumption()."&apikey=95876437f3b43ac241fdcd29658770ff";
   depthpost($data, "");
   }
   var_dump($data);
   sleep(20);
