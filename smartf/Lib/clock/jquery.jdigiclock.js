...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="Lib/clock/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="Lib/clock/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        switch (el.proxyType) {
            case 'php':
                proxy = 'Lib/clock/proxy.php';
            break;
            case 'asp':
                proxy = 'proxy/asp/WeatherProxy.aspx';
            break;
        }
